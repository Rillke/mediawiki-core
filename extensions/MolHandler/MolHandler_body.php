...
class MolHandler extends SvgHandler {
	...
	function doTransform( $image, $dstPath, $dstUrl, $params, $flags = 0 ) {
		...
		$status = $this->rasterize( $srcPath, $dstPath, $physicalWidth, $physicalHeight, $svgPath );
	 ...
	 */
	public function rasterize( $srcPath, $dstPath, $width, $height, $svgPath ) {
		...
		return parent::rasterize( $svgPath, $dstPath, $width, $height, $lang );
	}
